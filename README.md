...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 73a14906-069c-4a35-81ac-4f1b7eb62137
```

> `73a14906-069c-4a35-81ac-4f1b7eb62137` is the password of the certificate, you can change it to any password you want.
